...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://res.cloudinary.com/dawhmjhu1/image/upload/v1681210401/servifind/ServiFind_ya6xak.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 29%;max-width: 168.2px;" width="168.2" class="v-src-width v-src-max-width"/>
      </a>
    </td>
  </tr>
</table>
...
<table id="u_content_text_2" style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #5c5c5c; line-height: 170%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;"><strong>Hi [${name}], </strong></span></p>
<p style="font-size: 14px; line-height: 170%;"> </p>
<p style="font-size: 14px; line-height: 170%;"><span style="font-size: 18px; line-height: 30.6px;">Please confirm that you want to use this, as your ServiFind account email address. Once it's done you will be able to use your account!</span></p>
  </div>
...
<div align="center">
    ...
    <a href=${text} target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;font-family:'Rubik',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #11a327; border-radius: 10px;-webkit-border-radius: 10px; -moz-border-radius: 10px; width:47%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-width: 3px; border-top-style: solid; border-left-width: 3px; border-left-style: solid; border-right-width: 3px; border-right-style: solid; border-bottom-width: 3px; border-bottom-style: solid;font-size: 14px;">
      <span style="display:block;padding:16px 20px;line-height:120%;"><strong><span style="line-height: 16.8px;">Verify Now!</span></strong></span>
    </a>
