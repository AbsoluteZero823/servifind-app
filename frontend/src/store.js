...
const reducer = combineReducers({
    ...
    topUsersByMonth: getTransactionUsersMonthReducer,
    ...
    toPayData:getToPayData,
    toConfirmData:getToConfirmData,
    completedData:getCompletedData,
