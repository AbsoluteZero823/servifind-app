...
export const DISPLAYED_SERVICES_REQUEST = 'DISPLAYED_SERVICES_REQUEST'
export const DISPLAYED_SERVICES_SUCCESS = 'DISPLAYED_SERVICES_SUCCESS'
export const DISPLAYED_SERVICES_FAIL =    'DISPLAYED_SERVICES_FAIL'

export const PREMIUM_SERVICES_REQUEST = 'PREMIUM_SERVICES_REQUEST'
export const PREMIUM_SERVICES_SUCCESS = 'PREMIUM_SERVICES_SUCCESS'
export const PREMIUM_SERVICES_FAIL =    'PREMIUM_SERVICES_FAIL'
