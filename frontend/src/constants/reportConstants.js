...
export const GET_USERREPORTS_REQUEST = 'GET_USERREPORTS_REQUEST'
export const GET_USERREPORTS_SUCCESS = 'GET_USERREPORTS_SUCCESS'
export const GET_USERREPORTS_RESET = 'GET_USERREPORTS_RESET'
export const GET_USERREPORTS_FAIL = 'GET_USERREPORTS_FAIL'
