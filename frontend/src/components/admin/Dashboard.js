...
const Dashboard = () => {
  ...
  const handleProcessingPdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/transactions-processing-pdf', {
  ...
  const handleToPayPdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/transactions-to-pay-pdf', {
  ...
  const handleToConfirmPdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/transactions-to-confirm-pdf', {
  ...
  const handleCompletedPdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/transactions-completed-pdf', {
  ...
  const handleTopFreelancersPdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/top-freelancers-pdf', {
  ...
  const handleFreelancerMonthlyPdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/freelancer-monthly-join-pdf', {
  ...
  const handleTopServicesPdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/top-services-pdf', {
  ...
  const handleMonthlyIncomePdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/monthly-income-pdf', {
  ...
  const handleTransactionsPdf = async () => {
    ...
    try {
      const response = await fetch('http://10.0.2.15:3000/api/v1/transactions-pdf', {
